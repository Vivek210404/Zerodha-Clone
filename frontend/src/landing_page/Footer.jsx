    ...
    <footer style={{ backgroundColor: "rgb(250,250,250" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            <p className="fw-semibold text-dark fs-5 mb-3">Account</p>
          ...
          <div className="col">
            <p className="fw-semibold text-dark fs-5 mb-3">Support</p>
            <a href="">Contact us</a>
            <br />
          ...
          <div className="col">
            <p className="fw-semibold text-dark fs-5 mb-3">Company</p>
            <a href="">About</a>
            <br />
            <a href="">Philosophy</a>
            <br />
          ...
          <div className="col">
            <p className="fw-semibold text-dark fs-5 mb-3">Quick links</p>
